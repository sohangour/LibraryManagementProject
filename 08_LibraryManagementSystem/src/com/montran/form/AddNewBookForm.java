...
public class AddNewBookForm extends ActionForm {
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		...
		if (request.getParameter("getMemberData") != null && getMemberCode() == 0) {
			System.out.println("inside action error");
			errors.add("memberCodeError", new ActionMessage("error.label.memberCode"));
		}
